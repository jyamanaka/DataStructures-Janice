...
app.get('/sensor', function(req, res) {
    ...
    // SQL query 
    //changed because our sensorValue field is null. sensorValue is for sensor positioning
...
app.get('/aameetings', function(req, res) {
    ...
    */
    // SQL query 
    /*var thisQuery = `SELECT newAddress as mtgaddress, title as location, json_agg(json_build_object('day', day, 'time', startTime)) as meetings
                 FROM aaMeetings 
                 WHERE day = 'Tuesday'  
...
app.get('/deardiary', function(req, res) {
    ...
    AWS.config.accessKeyId = "AAKIAJJGVBBTRIKAD2CHA";
    AWS.config.secretAccessKey = "MSYbeHwZE1/dAqM8wcean7uGzcB3760Vn0XmbfzK";
